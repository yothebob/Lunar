...
{
draw_text_ext(x,y,"Earths Leaders need to study Lunar political regions, regions and cultures for a good relation..",20,500);
	if pick == -1
	{
	pick = irandom(1);
	}
	...
	switch(pick)
		{
		case 0:
		draw_text_ext(x,y + 60,"Within months we will have multiple experts in Lunar languages, history, political leadership and cultures..",20,500);
		break;
		case 1:
		draw_text_ext(x,y + 60,"Earths universities drag to incorporate new Lunar subjects. Translations will be rough..", 20,500);
		break;
		}
	}
	if ii == 2 
...
{
draw_text_ext(x,y, "tesyt",20,500);
